//
//  ColorHelperImplementation.swift
//  SPM_Foundations
//
...
final class ColorHelperImplementation: ColorHelper {
    static let shared = ColorHelperImplementation()
    ...
    func getColor(_ type: ColorType) -> Color {
        switch type {
            ...
            case .darkThemeBackground:
                return Color(red: 42/255, green: 50/255, blue: 64/255)
